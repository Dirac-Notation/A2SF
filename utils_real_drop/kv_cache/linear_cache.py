...
class LinearCache(KVCache):
    ...
    def init_cache(self, compression_config, layer_idx):
        """Initialize Linear cache settings"""
        self.seq_length = 0
    ...
    def flash_prepare_scores(self, attn_scores, q_start, q_end):
        ...
        return torch.maximum((attn_scores - forgetting), torch.zeros_like(attn_scores)).sum(dim=self.seq_dim)
